...
<div id="Navigation"> 
		...
		<ul style = "list-style: none;">
			...
			<li class="<?php if ($thisPage=="articlesIndex") {echo "active"; } else  {echo "noactive";}?>">
			...
			<li class="<?php if ($thisPage=="gamesIndex") {echo "active"; } else  {echo "noactive";}?>">
			<a href="./gamesIndex.php">Awesome Games!!</a></li>			
		</ul>
