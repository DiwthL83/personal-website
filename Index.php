...
<?php include ("top.php"); ?>
		...
		<div id="right_side"> 
			<h1 style="text-align: center; font-size: 40px;"> <b>Welcome! </b></h1>

			<p><?php echo "Hello! You've found your way to the page of Jerry Samuels Jr., known internationally as Geraldo Samuél. Please take your time and peruse my site, and by all means, reach out to me if you have any questions or comments you think (or <i>\"feel\"</i>) merit a discussion."; ?></p>
			<br>
			<br>
			<h3 style="text-align: center; font-size: 26px;"> My Bio </h3>
			<p> I was a military brat in my early years and lived in Europe (Italy and England) through most of my grade school, making in stateside in time to start high school on American soil. After graduating high school, pragmatism (see: fiscal constraints) led me to pursue an undergraduate education at my alma mater, University of Nebraska at Omaha (go Mavs!!). After spending a fair amount of time overwhelmed with the chocies presented to me, I settled on a Bachelor of Arts degree in International Studies.</p>
